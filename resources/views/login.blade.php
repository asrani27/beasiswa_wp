...
<div class="wrapper">
  ...
  <!-- Full Width Column -->
  <div class="content-wrapper"  style="background-image: url('http://localhost:8000/logo/bea.jpg'); background-size:cover">
    <div class="container">
          ...
          <br/><br/>
            <div class="box box-success" style="box-shadow: 0 8px 8px 0 rgba(0,0,0,.2);border-top-color:#fe5000">
              <div class="box-header with-border text-center">
                <h3 class="box-title">Aplikasi Seleksi Beasiswa Mts Al-Islamiyah “SMIP” 1946 </h3>
              </div>
